...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 213 + 209) / 419)
exe 'vert 2resize ' . ((&columns * 205 + 209) / 419)
argglobal
setlocal fdm=indent
setlocal fde=0
setlocal fmr={{{,}}}
...
55
normal! zo
let s:l = 52 - ((20 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
52
...
15
normal! zo
let s:l = 53 - ((24 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
53
...
setlocal fdn=20
setlocal fen
let s:l = 157 - ((20 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
157
